...
- 📊 Direciono minha disciplina administrativa para **análise de dados**
...
- 🌱 Aprofundando conhecimentos em **SQL, Python, Power BI e Excel avançado**
- 💼 +4 anos de experiência em rotinas administrativas e organização de processos
- 🎯 Em busca de um **estágio na área de dados/tecnologia**

## 🚀 Tecnologias

### Dados & Análise

![](https://skillicons.dev/icons?i=py,mysql,postgres,java,js)
